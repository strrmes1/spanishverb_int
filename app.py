...
🧠 Умное повторение
Алгоритм SM-2 показывает карточки именно тогда, когда вы готовы их забыть
...
Отслеживайте прогресс по каждому глаголу и времени отдельно
...
Изучайте на любом устройстве, прогресс синхронизируется автоматически
